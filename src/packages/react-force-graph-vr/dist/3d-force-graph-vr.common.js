...
var _3dForceGraphVr = Kapsule({
  ...
  methods: {
    emitParticle: function emitParticle(state) {
      var _state$forcegraph$com;

      for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        args[_key - 1] = arguments[_key];
      }

      (_state$forcegraph$com = state.forcegraph.components.forcegraph).emitParticle.apply(_state$forcegraph$com, args);
